  ...
  programs.nixvim = {
    ...
    extraConfigLua = ''
      ...
      local function apply_theme_overrides()
        ...
        set(0, "BufferTabpageFill",     { bg = "NONE" })
        set(0, "BufferCurrent",         { bg = "NONE" })
        set(0, "BufferCurrentMod",      { bg = "NONE" })
        set(0, "BufferCurrentSign",     { bg = "NONE" })
        set(0, "BufferCurrentIcon",     { bg = "NONE" })
        set(0, "BufferCurrentTarget",   { bg = "NONE" })
        set(0, "BufferVisible",         { bg = "NONE" })
        set(0, "BufferVisibleMod",      { bg = "NONE" })
        set(0, "BufferVisibleSign",     { bg = "NONE" })
        set(0, "BufferVisibleIcon",     { bg = "NONE" })
        set(0, "BufferVisibleTarget",   { bg = "NONE" })
        set(0, "BufferInactive",        { bg = "NONE" })
        set(0, "BufferInactiveMod",     { bg = "NONE" })
        set(0, "BufferInactiveSign",    { bg = "NONE" })
        set(0, "BufferInactiveIcon",    { bg = "NONE" })
        set(0, "BufferInactiveTarget",  { bg = "NONE" })
